...
export const CURATED_VOICES: CuratedVoice[] = [
  ...
  },
  {
    ...
    name: "George",
    desc: "Trustworthy & steady",
    description: "Trustworthy & steady",
    accent: "British",
    gender: "male",
    age: "middle-aged",
    tone: "steady",
    bestFor: "Finance, insurance, enterprise",
  },
  {
    id: "pFZP5JQG7iQjIQuC4Bku",
    name: "Lily",
    desc: "Bright & youthful",
    description: "Bright & youthful",
    accent: "British",
    gender: "female",
    age: "young",
    tone: "bright",
    bestFor: "Retail, hospitality, events",
  },
  {
    id: "zbg2SwAbIRjYLbpDeH5Z",
    name: "Marcus",
    desc: "Deep & composed",
    ...
    age: "middle-aged",
    tone: "composed",
    bestFor: "Enterprise, security, after-hours",
  },
  {
    id: "9BWtsMINqrJLrRacOk9x",
    name: "Aria",
    desc: "Versatile & clear",
    description: "Versatile & clear",
    accent: "American",
    gender: "female",
    age: "young",
    tone: "clear",
    bestFor: "Multi-industry, general reception",
  },
];
