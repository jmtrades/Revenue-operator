    ...
    .upsert(
      {
        ...
        date: date,
        calls_answered: Math.max(0, metrics.total_calls - metrics.missed_calls),
        calls_missed: metrics.missed_calls,
        appointments_booked: metrics.total_appointments,
        leads_captured: metrics.total_leads,
        no_shows: 0,
        no_shows_recovered: metrics.recovered_calls,
        follow_ups_sent: 0,
        revenue_estimated_cents: metrics.total_revenue_cents,
        response_time_avg_seconds: metrics.avg_call_duration_seconds,
