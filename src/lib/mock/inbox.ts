...
export const MOCK_INBOX_THREADS: InboxThread[] = [
  {
    ...
    channel: "phone",
    lastMessage: "AI confirmed appointment for tomorrow at 10 AM.",
    ...
    messages: [
      {
        id: "m-1-1",
        sender: "agent",
        content: "Inbound call from Mike Johnson about a leaking water heater.",
      ...
      },
      {
        id: "m-1-2",
        sender: "agent",
        content: "I can help with that. Are you seeing any water on the floor or just reduced hot water?",
      ...
      },
      {
        id: "m-1-3",
        sender: "contact",
        content: "There is some water on the floor and it only gets warm for a minute.",
      ...
      },
      {
        id: "m-1-4",
        sender: "agent",
        content: "Thanks. I’ve booked you for tomorrow at 10 AM with our technician.",
