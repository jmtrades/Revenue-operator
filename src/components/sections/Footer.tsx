...
import { FOOTER_PRODUCT, FOOTER_COMPANY, FOOTER_LEGAL } from "@/lib/constants";
...
export function Footer() {
  return (
    ...
    >
      <Container>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8" style={{ paddingBottom: "48px" }}>
          <div>
