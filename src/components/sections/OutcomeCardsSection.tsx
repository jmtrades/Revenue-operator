          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {pricingTiers.map((tier) => (
              ...
              >
                ...
                <button
                  type="button"
                  className="mt-auto inline-flex items-center justify-center px-4 py-2.5 rounded-xl bg-white text-black text-sm font-semibold hover:opacity-90 transition-colors"
                >
                  {t("cta.button")}
                </button>
              </div>
