...
import { Phone, PhoneOutgoing, Calendar, Target, AlertCircle, MessageSquare, Brain, BarChart3 } from "lucide-react";
...
const CAPABILITIES = [
  ...
  { icon: BarChart3, title: "Tracks everything", desc: "Calls, leads, revenue, all in one place." },
];
  ...
  return (
    <section id="capabilities" className="marketing-section" style={{ background: "var(--bg-primary)" }}>
      <Container>
        ...
        <StaggerChildren className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
