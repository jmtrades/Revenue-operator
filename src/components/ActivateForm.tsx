    ...
    return (
      <div className="text-center">
        ...
        <button
          ...
          className="w-full max-w-[320px] py-3.5 bg-white text-black rounded-xl font-semibold hover:bg-[var(--bg-hover)] transition"
        >
          {t("setUpAgent")}
        </button>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="w-full max-w-[320px] py-3.5 bg-white text-black rounded-xl font-semibold hover:bg-[var(--bg-hover)] transition disabled:opacity-60"
      >
      ...
      {error && (
        <div className="mt-4 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
          ...
          <button
            ...
            className="w-full py-2 px-4 rounded-lg text-sm font-medium bg-white text-black hover:bg-[var(--bg-hover)] transition"
          >
            {t("tryAgain")}
          </button>
        </div>
