...
const STATS = [
  {
    ...
    suffix: "",
    label: "AI Voices",
    sublabel: "Across 11 industry presets",
    color: "emerald",
    raw: true,
  },
  {
    ...
    suffix: "s",
    label: "Response Time",
    sublabel: "Average first-word latency",
    color: "blue",
    decimals: 1,
    raw: true,
  },
  {
    ...
    suffix: "/7",
    label: "Always On",
    sublabel: "Every call answered, every shift",
    color: "amber",
    decimals: 0,
    raw: true,
  },
  ...
  },
  {
    ...
    sublabel: "Local numbers nationwide",
    color: "cyan",
    raw: true,
  },
  {
    ...
    suffix: "",
    label: "Industries",
    sublabel: "Purpose-built voice agents",
    color: "rose",
    decimals: 0,
    raw: true,
  },
