...
const TESTIMONIALS = [
  ...
  {
    quote: "Setup literally took 3 minutes. That's not marketing speak — I timed it. Our AI operator was taking calls before I finished my coffee. It paid for itself within the first day.",
    name: "Sarah Kim",
    role: "Owner",
