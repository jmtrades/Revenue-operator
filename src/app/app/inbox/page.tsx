      ...
      <div className="flex-1 overflow-y-auto">
        {filtered.length === 0 ? (
          ...
          return (
            ...
            >
              <div className="w-8 h-8 rounded-full bg-[var(--bg-inset)] flex items-center justify-center text-xs font-semibold text-zinc-200 shrink-0">
                {thread.contactName
                  .split(" ")
                  .map((p) => p[0])
                  .join("")
    ...
    <div className="flex flex-col h-full border-l border-[var(--border-default)] md:border-l-0">
      <div className="flex items-center justify-between px-4 py-3 border-b border-[var(--border-default)] bg-[var(--bg-card)]/80">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <span className="ml-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] bg-[var(--bg-inset)] text-zinc-300">
        ...
        <button
          ...
          className="text-xs font-medium px-3 py-1.5 rounded-xl border border-[var(--border-medium)] text-zinc-200 hover:bg-[var(--bg-inset)] shrink-0"
        >
