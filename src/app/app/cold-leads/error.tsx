...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] p-8">
      <div className="w-12 h-12 rounded-xl bg-[var(--accent-danger,#ef4444)]/10 flex items-center justify-center mb-4">
        <svg className="w-6 h-6 text-[var(--accent-danger,#ef4444)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <p className="text-sm text-[var(--text-tertiary)] text-center max-w-sm mb-6">
        {error?.digest ? t("defaultMessage") : (error?.message || t("defaultMessage"))}
      </p>
