        ...
        {loading ? (
          ...
          <div className="space-y-6">
            <EmptyState
              ...
              description={t("appointments.empty.body", { defaultValue: "Appointments appear here when your AI operator books meetings for your leads. Connect your calendar to enable booking." })}
              primaryAction={{
