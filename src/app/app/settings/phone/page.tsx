  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <p className="text-xs text-[var(--text-secondary)] mt-6">
        {tPhone("needHelpPhoneSetup")} <a href="mailto:support@revenue-operator.com" className="text-[var(--text-tertiary)] hover:text-[var(--text-primary)] underline underline-offset-2">support@revenue-operator.com</a>
      </p>
