          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-card)] p-6 md:p-8 mb-8">
              ...
              <div className="space-y-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
                ...
                <p>
                  The second failure is lack of qualification. A caller might be a serious buyer, a tire-kicker, or a competitor's agent fishing for market intel. Without quick screening, you waste time showing properties to unqualified prospects. Recall Touch clarifies intent immediately: "Are you looking to buy, sell, or just curious about the area?"
                </p>
                <p>
            ...
            <h2 className="text-lg font-semibold mb-3">How Recall Touch works for real estate</h2>
            <div className="space-y-4 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
              <p>
                Recall Touch answers calls to your listing or office number 24/7. It greets the caller, asks if they're looking to buy, sell, or learn more, and captures their name and preferred times to view. If you're the agent available, Recall Touch offers your calendar slots. If you're busy, it can offer team members or suggest multiple options.
              </p>
              <p>
                Once a showing is booked, Recall Touch sends the buyer a confirmation text with the address, time, and parking instructions. It reminds them 24 hours before and again 1 hour before. If they don't show up, it offers to reschedule immediately.
              </p>
              <p>
                For listings with high inquiry volume, Recall Touch can automate follow-up: "The showing is scheduled for 3 PM Thursday. Do you have any questions about the property?" It can answer pre-written FAQs (square footage, HOA fees, school district) or route complex questions to you.
              </p>
            </div>
            ...
            <div className="space-y-4 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
              ...
              <p>
                Beyond pure revenue, Recall Touch reduces your manual calendar management. You're not juggling five texts, two emails, and a phone call to schedule one showing. The system does it. That time goes back to your actual business: building relationships and closing deals.
              </p>
              <p>
