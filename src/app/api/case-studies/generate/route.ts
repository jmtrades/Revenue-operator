...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const quote = `In ${resolvedIndustry}, we recovered ${after.revenueRecovered} by turning missed calls and no-shows into booked outcomes. ${after.callsRecovered} call recoveries, ${after.noShowsRecovered} no-show recoveries, and ${after.reactivations} reactivations moved the pipeline forward.`;
