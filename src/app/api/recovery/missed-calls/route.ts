/**
 * GET /api/recovery/missed-calls — Returns unanswered calls with recovery status.
 * Queries call_sessions where outcome indicates an unanswered call (no_answer, busy, voicemail)
