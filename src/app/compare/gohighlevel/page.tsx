...
export const metadata: Metadata = {
  ...
  description:
    "GoHighLevel vs Recall Touch: compare setup time, voice AI capability, missed call recovery, and pricing. Recall Touch delivers AI phone + revenue ops in under 3 minutes.",
...
const rows: Row[] = [
  ...
  { feature: "24/7 missed call answering", recall: true, ghl: false, note: "Recall Touch answers every missed call. GHL requires manual workflow setup and doesn't focus on inbound recovery." },
  { feature: "Automatic missed call recovery sequences", recall: true, ghl: false, note: "Recall Touch runs follow-up sequences automatically until next outcome. GHL requires manual workflow builders." },
        ...
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-4 text-base md:text-lg" style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
              ...
              that answers calls, recovers missed opportunities, and scales outbound campaigns — live in under 3 minutes.
            </p>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-card)] p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.6 }}>
                ...
                <li>Automatic missed call recovery: sequences run until next outcome</li>
            ...
            <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-card)] p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.6 }}>
                ...
                <li>Manual missed call handling: requires custom workflows, no auto-recovery</li>
          ...
          <section className="mt-10 max-w-5xl mx-auto">
            ...
            <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
              This table focuses on the capabilities that determine revenue execution speed: how fast you go live, voice quality, missed call recovery, and total cost of ownership.
            </p>
                ...
                <tbody>
                  {rows.map((r) => (
                    <tr key={r.feature} className="border-b border-[var(--border-default)]">
                      ...
                      <td className="px-6 py-4 text-center">
                        {r.ghl ? <CheckCircle2 className="w-5 h-5 mx-auto text-emerald-400" aria-hidden /> : <XCircle className="w-5 h-5 mx-auto text-zinc-600" aria-hidden />}
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
                  ...
                  That's weeks of work before your first missed call gets answered.
                </p>
                <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
                ...
                <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
                  When every missed call is money lost, speed of deployment is a revenue metric.
                </p>
              </div>
              <div>
                ...
                <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
                  For inbound missed call recovery, voice quality is a conversion tool.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mt-12 max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h2 className="text-xl font-bold" style={{ color: "var(--text-primary)" }}>Missed calls don&apos;t wait for your workflows</h2>
                <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
                  With GoHighLevel, you need to build a workflow every time you want to recover a missed call. That&apos;s custom logic, testing, and tweaking.
                  By the time it&apos;s live, you&apos;ve lost time and calls.
                </p>
                <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
                  Recall Touch handles missed call recovery automatically. Answer → SMS → follow-up → next outcome. All built in. No workflow to create.
                </p>
              </div>
              <div>
          ...
          <section className="mt-12 max-w-5xl mx-auto">
            <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-inset)] p-8">
              ...
              <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
                If you need missed call recovery, voice AI, and revenue execution working today — not weeks from now — Recall Touch is your move.
              </p>
              ...
              <p className="mt-4 text-xs" style={{ color: "var(--text-tertiary)" }}>
                Tip: no credit card required. Connect your number and take your first missed call in under 5 minutes.
              </p>
            </div>
          </section>
        </Container>
