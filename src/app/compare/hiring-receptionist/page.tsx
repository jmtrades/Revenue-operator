        ...
        <Container>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-card)] p-6">
              ...
              <ul className="mt-4 space-y-2 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.6 }}>
                ...
                <li>Handles one call at a time (overflow = missed calls)</li>
                ...
                <tbody>
                  {rows.map((r) => (
                    <tr key={r.feature} className="border-b border-[var(--border-default)]">
                      ...
                      <td className="px-6 py-4 text-center">
                        {r.receptionist ? <CheckCircle2 className="w-5 h-5 mx-auto text-emerald-400" aria-hidden /> : <XCircle className="w-5 h-5 mx-auto text-zinc-600" aria-hidden />}
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          <section className="mt-12 max-w-5xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.8 }}>
                  That speed difference compounds: one missed call today = one lost customer. One call answered quickly = one scheduled appointment.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mt-12 max-w-5xl mx-auto">
            <div className="rounded-2xl border border-[var(--border-default)] bg-[var(--bg-inset)] p-8">
              ...
              <p className="mt-3 text-sm" style={{ color: "var(--text-secondary)", lineHeight: 1.7 }}>
                Recall Touch handles the missed calls, the after-hours volume, the follow-ups, and the no-show recovery. Your receptionist stays focused
