...
const DEMO_FOLLOW_UPS: FollowUpItem[] = [
  {
    ...
    sequenceName: "Missed call → booking",
    currentStep: 2,
    totalSteps: 3,
...
function statusConfig(status: FollowUpStatus): { label: string; color: string } {
  switch (status) {
    case "active":
      return { label: "Active", color: "bg-zinc-900/60 text-blue-400 border-zinc-800" };
    case "paused":
              ...
              <table className="w-full text-left text-sm">
                <thead>
                  <tr className="border-b border-zinc-800/80">
                    <th className="py-3 px-4 font-medium text-zinc-400">Contact</th>
                    <th className="py-3 px-4 font-medium text-zinc-400">Sequence</th>
                    <th className="py-3 px-4 font-medium text-zinc-400">Step</th>
                    <th className="py-3 px-4 font-medium text-zinc-400">Due</th>
                    <th className="py-3 px-4 font-medium text-zinc-400">Status</th>
                    <th className="py-3 px-4 font-medium text-zinc-400">Channel</th>
                        ...
                        <td className="py-3 px-4">
                          <div className="flex items-center justify-end gap-2 text-xs">
                            {item.status === "paused" ? (
                              ...
                              <button
                                type="button"
                                className="inline-flex items-center gap-1 rounded-full border border-zinc-700 px-2 py-1 text-zinc-200 hover:bg-zinc-800/80 transition-colors"
                              >
