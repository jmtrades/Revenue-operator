      ...
      {!workspaceId ? (
        ...
        <div className="space-y-6 rounded-lg border p-6" style={{ borderColor: "var(--border)", background: "var(--surface-card)" }}>
          ...
          <div className="flex gap-3">
            <Link href={`/dashboard/templates${q}`} className="px-4 py-2 text-sm font-medium rounded-lg" style={{ background: "var(--btn-primary-bg)", border: "1px solid var(--border)", color: "var(--text-primary)" }}>
              Choose template
            </Link>
