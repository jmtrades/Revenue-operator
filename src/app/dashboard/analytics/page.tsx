...
export default function AnalyticsPage() {
  ...
  const metrics = useMemo(() => {
    ...
    const missedCallsRecovered = Math.round(callsAnswered * 0.35); // 35% were after hours
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-xl border p-5" style={{ borderColor: "var(--border-default)", background: "var(--bg-surface)" }}>
              ...
              <p className="text-2xl font-bold tabular-nums" style={{ color: "var(--text-primary)" }}>
                {metrics?.missedCallsRecovered || 0}
              </p>
          ...
          <div className="rounded-xl border p-6" style={{ borderColor: "var(--border-default)", background: "var(--bg-surface)" }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div>
                <p className="text-xs text-white/40 mb-1">Plan Cost</p>
                <p className="text-lg font-semibold" style={{ color: "var(--text-primary)" }}>$297/mo</p>
              </div>
              <div>
                <p className="text-xs text-white/40 mb-1">Revenue Recovered</p>
