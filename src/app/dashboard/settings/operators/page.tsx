...
export default function OperatorsPage() {
  ...
  return (
    <div className="p-8 max-w-2xl">
      <PageHeader title="Operators" subtitle="Manage operator seats and access." />
      <div className="mt-6 rounded-lg border p-6" style={{ borderColor: "var(--border)", background: "var(--surface-card)" }}>
        <p className="text-sm" style={{ color: "var(--text-secondary)" }}>Operator management is configured in main settings.</p>
      </div>
