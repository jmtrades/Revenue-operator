        ...
        <Container>
          <section className="max-w-3xl mb-16">
            ...
            <p className="text-lg" style={{ color: "var(--text-secondary)", lineHeight: 1.65 }}>
              Handle every call, text, and follow-up. Book appointments. Qualify leads. See everything in one dashboard.
            </p>
          </section>
          ...
          <section id="compliance-governance" className="mt-20 mb-20 py-12 px-6 rounded-2xl border" style={{ borderColor: "var(--border-default)", background: "var(--bg-surface)" }}>
