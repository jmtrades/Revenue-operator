...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Automatically detects missed calls, cold leads, no-shows, open quotes, and dormant customers. Estimates dollar amounts at risk. One-click recovery actions. The Revenue At Risk widget shows exactly what you're losing and how to fix it.",
