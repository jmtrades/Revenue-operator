...
const RESOURCE_TOPICS = [
  ...
  { title: "Missed Call Recovery", description: "Turn missed calls into opportunities. Automate callbacks, follow-ups, and lead recovery at scale." },
      ...
      <main className="pt-28 pb-24">
        <Container>
          <div className="max-w-3xl mb-16">
            ...
            <p className="text-base" style={{ color: "var(--text-secondary)", lineHeight: 1.65 }}>Guides, playbooks, and industry insights on answering missed calls, automating follow-up, and measuring the revenue impact. Join our mailing list to get new content as it publishes.</p>
          </div>
          ...
          <div className="mt-16 pt-12 border-t text-center" style={{ borderColor: "var(--border-default)" }}>
            <p className="mb-6" style={{ color: "var(--text-secondary)" }}>Ready to see how Recall Touch captures missed calls?</p>
