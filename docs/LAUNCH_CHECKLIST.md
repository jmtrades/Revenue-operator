...
- Typical routes: process-queue, no-reply, renewal-reminder, learning, etc.
...
1. Run a quick smoke test: landing → activate → (checkout if configured) → onboarding → live → overview.
